...
class FaceRecognizer:
    def __init__(self, face_cascade_path, model_path, whitelist_path, blacklist_path):
        ...
        self.cap = cv2.VideoCapture("http://192.168.1.51:8080/stream?topic=/usb_cam/image_raw")  # Replace with the correct stream URL
    ...
    def process_frames(self):
        """Process frames and perform face recognition every 0.25 seconds without slowing down the video."""
        while True:
            try:
            ...
            if current_time - self.last_processed_time >= self.processing_interval:
                ...
                for (x, y, w, h) in faces:
                    ...
                    if confidence < 75 and id < len(self.names):
                        name = self.names[id]
                    else:
                        name = "unknown"
                    ...
                    cv2.putText(
                        frame, f"{name} {confidence_text}", (x+5, y-5),
            ...
            # Display the video frame regardless of processing
    ...
    def count_names(self):
        ...
        while True:
            ...
            if counts.get('unknown', 0) > (3*total_counts) / 4:
                # Stranger detected
